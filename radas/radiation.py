...
def calculate_Lz(dataset: xr.Dataset, charge_state_fraction: xr.DataArray) -> xr.DataArray:
    ...
    electron_emission_per_charge_state = ((dataset.line_emission_from_excitation + dataset.recombination_and_bremsstrahlung) * charge_state_fraction)

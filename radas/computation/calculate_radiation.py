...
def calculate_electron_emission_prefactor(dataset: xr.Dataset, charge_state_fraction: xr.DataArray) -> xr.DataArray:
    ...
    electron_emission_per_charge_state = ((dataset.line_emission_coeff + dataset.continuum_emission_coeff) * charge_state_fraction)
